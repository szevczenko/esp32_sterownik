...
{
  if ( ( ( parameters_getValue( PARAM_MOTOR_IS_ON ) == 0 ) && ( parameters_getValue( PARAM_SERVO_IS_ON ) == 0 ) && backendIsConnected() ) || !backendIsConnected() )
  {
...
{
  if ( ( parameters_getValue( PARAM_MOTOR_IS_ON ) || parameters_getValue( PARAM_SERVO_IS_ON ) ) && backendIsConnected() )
  {
